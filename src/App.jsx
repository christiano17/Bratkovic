...
function App() {
  ...
  return (
    <>
      ...
      {/* MOBILE NAV OVERLAY */}
      <div className={`mobile-nav-overlay${menuOpen ? ' open' : ''}`} onClick={closeMenu} aria-hidden="true" />
      <div className={`mobile-nav${menuOpen ? ' open' : ''}`} role="dialog" aria-label="Navigacija">
        <button className="mobile-nav-close" onClick={closeMenu} aria-label="Zapri meni">✕</button>
        <ul>
          <li><a href="#storitve" onClick={closeMenu}>Storitve</a></li>
